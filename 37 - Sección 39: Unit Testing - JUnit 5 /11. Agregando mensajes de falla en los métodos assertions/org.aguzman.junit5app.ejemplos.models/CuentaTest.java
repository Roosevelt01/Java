...
class CuentaTest{
    ...
    void testNombreCuenta(){
        ...
        // Paso 3: Verificar que el nombre no sea nulo con mensaje personalizado
        assertNotNull(real, () -> "La cuenta no puede ser nula");

        // Paso 4: Verificar que el nombre sea igual al esperado con mensaje personalizado
        assertEquals(esperado, real, () -> 
            "El nombre de la cuenta no es el que se esperaba: se esperaba '" + esperado + "' pero fue '" + real + "'");

        // Paso 5: Verificar que el nombre cumpla una condición con mensaje personalizado
        assertTrue(real.equals("Andres"), () -> "El nombre esperado debe ser igual al real");
    }
